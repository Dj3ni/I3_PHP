 ...
 */
final class Version20240905144642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, name VARCHAR(150) NOT NULL, phone_number VARCHAR(50) DEFAULT NULL, email VARCHAR(255) NOT NULL, type VARCHAR(150) DEFAULT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_B8EE3872F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE club_game_library (id INT AUTO_INCREMENT NOT NULL, club_id INT NOT NULL, INDEX IDX_4EF64F6361190A32 (club_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE club_subscription (id INT AUTO_INCREMENT NOT NULL, user_subscriptor_id INT NOT NULL, club_subscripted_id INT NOT NULL, subscription_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_contribution_ok TINYINT(1) NOT NULL, INDEX IDX_D972CC233CECDD17 (user_subscriptor_id), INDEX IDX_D972CC23A41AA27F (club_subscripted_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, user_organisator_id INT NOT NULL, title VARCHAR(150) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, date_occurency INT DEFAULT NULL, type VARCHAR(150) DEFAULT NULL, fee NUMERIC(10, 2) NOT NULL, INDEX IDX_3BAE0AA794589191 (user_organisator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_subscription (id INT AUTO_INCREMENT NOT NULL, user_subscriptor_id INT NOT NULL, event_subscripted_id INT NOT NULL, date_subscription DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4ED56E203CECDD17 (user_subscriptor_id), INDEX IDX_4ED56E20B7EFA4DF (event_subscripted_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game_library_historic (id INT AUTO_INCREMENT NOT NULL, club_game_library_id INT NOT NULL, boardgame_id INT NOT NULL, INDEX IDX_B5E0D95EFEFB4E4 (club_game_library_id), INDEX IDX_B5E0D95EB1A27A21 (boardgame_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_management (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, game_artwork_id INT NOT NULL, INDEX IDX_E59252A2A76ED395 (user_id), INDEX IDX_E59252A2E3643849 (game_artwork_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gaming_place (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, address_id INT NOT NULL, name VARCHAR(150) NOT NULL, INDEX IDX_A60B6C3F71F7E88B (event_id), UNIQUE INDEX UNIQ_A60B6C3FF5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
